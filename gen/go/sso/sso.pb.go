...
type RegisterRequest struct {
	...
	Nick     string `protobuf:"bytes,1,opt,name=nick,proto3" json:"nick,omitempty"`         // Nickname of the user to register.
	...
	Token    string `protobuf:"bytes,4,opt,name=token,proto3" json:"token,omitempty"`       // Auth token of the logged in user.
}
...
type RegisterResponse struct {
	...
	Nick   string `protobuf:"bytes,2,opt,name=nick,proto3" json:"nick,omitempty"`                    // Nickname of the user to register.
	Email  string `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`                  // Email of the user to register.
}
...
func (x *RegisterResponse) GetNick() string {
	if x != nil {
		return x.Nick
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x69, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x55, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
	...
	0x04, 0x6e, 0x69, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x57, 0x0a, 0x0c, 0x4c,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x14, 0x5a, 0x12, 0x74, 0x75, 0x7a,
	0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x32, 0x62,
